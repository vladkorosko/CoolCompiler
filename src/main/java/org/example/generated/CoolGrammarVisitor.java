...
public interface CoolGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CoolGrammarParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitType(CoolGrammarParser.TypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CoolGrammarParser}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
