...
public interface CoolGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CoolGrammarParser#type}.
	 * @param ctx the parse tree
	 */
	void enterType(CoolGrammarParser.TypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link CoolGrammarParser#type}.
	 * @param ctx the parse tree
	 */
	void exitType(CoolGrammarParser.TypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CoolGrammarParser}.
	 * @param ctx the parse tree
	 */
	void enterNew(CoolGrammarParser.NewContext ctx);
	/**
	 * Exit a parse tree produced by {@link CoolGrammarParser}.
	 * @param ctx the parse tree
	 */
